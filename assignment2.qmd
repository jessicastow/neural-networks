...
## Correct target variable imbalance using undersampling 
...
history <- model %>% fit(
  x_train, y_train, 
  epochs = 500, # nr of times model trains on the entire data set
  batch_size = 25, # # nr of samples processed before updating the model
